    ...
    <div class="items-center block w-full h-auto grow basis-full" id="sidenav-collapse-main">
        <nav class="space-y-3">
            ...
            <Link href="{{ route('dashboard.index') }}" class="{{ request()->routeIs('dashboard.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">
                ...
                <span class="mx-2 text-sm">@lang('Dashboard')</span>
            </Link>
            ...
            <x-splade-dropdown class="w-full">
                <x-slot:trigger>
                    <a class="text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out" href="#">
                        ...
                        <span class="mx-2 text-sm">@lang('Student')</span>
                    </a>
                    </x-slot>
                    <div class="w-48 mt-2 p-1 divide-y divide-gray-100 rounded-lg bg-white shadow-lg ring-1 ring-gray-950/5 transition dark:divide-white/5 dark:bg-gray-900 dark:ring-white/10">
                        <x-dropdown-link :href="route('dashboard.student.index')">
                            @lang('All Students')
                        </x-dropdown-link>
                    </div>
            </x-splade-dropdown>
            ...
            <Link href="{{ route('dashboard.teacher.index') }}"
                  class="{{ request()->routeIs('dashboard.teacher.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">
            <i class="fas fa-chalkboard-teacher"></i>
            <span class="mx-2 text-sm">@lang('Teachers')</span>
            </Link>

{{--            sections--}}
{{--            <Link href="{{ route('dashboard.section.index') }}"--}}
{{--                  class="{{ request()->routeIs('dashboard.section.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">--}}
{{--            <i class="fas fa-th-list"></i>--}}
{{--            <span class="mx-2 text-sm">@lang('Sections')</span>--}}
{{--            </Link>--}}

{{--            standard--}}
            <Link href="{{ route('dashboard.standard.index') }}"
                  class="{{ request()->routeIs('dashboard.standard.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">
            <i class="fas fa-table"></i>
            <span class="mx-2 text-sm">@lang('Standards')</span>
            </Link>

{{--            subject --}}
            <Link href="{{ route('dashboard.subject.index') }}"
                  class="{{ request()->routeIs('dashboard.subject.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">
            <i class="fas fa-book"></i>
            <span class="mx-2 text-sm">@lang('Subjects')</span>
            </Link>
            ...
            <x-splade-dropdown class="w-full">
                <x-slot:trigger>
                    <a class="text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out" href="#">
                        ...
                        <span class="mx-2 text-sm">@lang('Addresses')</span>
                    </a>
                    </x-slot>
                    <div class="w-48 mt-2 p-1 divide-y divide-gray-100 rounded-lg bg-white shadow-lg ring-1 ring-gray-950/5 transition dark:divide-white/5 dark:bg-gray-900 dark:ring-white/10">
                        <x-dropdown-link :href="route('dashboard.sAddress.index')">
                            <i class="fas fa-circle"></i>
                            @lang('Student Addresses')
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('dashboard.tAddress.index')">
                            <i class="fas fa-circle"></i>
                            @lang('Teacher Addresses')
                        </x-dropdown-link>
                    </div>
            </x-splade-dropdown>

{{--            exams--}}
            <Link href="{{ route('dashboard.exam.index') }}"
                  class="{{ request()->routeIs('dashboard.exam.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">
            <i class="fas fa-radiation"></i>
            <span class="mx-2 text-sm">@lang('Exams')</span>
            </Link>

{{--            scores--}}
            <Link href="{{ route('dashboard.score.index') }}"
                  class="{{ request()->routeIs('dashboard.score.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">
            <i class="fas fa-radiation"></i>
            <span class="mx-2 text-sm">@lang('Scores')</span>
            </Link>

{{--            standard batch subject--}}
            <Link href="{{ route('dashboard.standardBatchSubject.index') }}"
                  class="{{ request()->routeIs('dashboard.standardBatchSubject.index') ? 'bg-indigo-50 dark:bg-indigo-400 text-gray-700 dark:text-white font-semibold' : '' }} text-sm py-3 my-0 mx-2 flex items-center whitespace-nowrap px-4 font-medium text-gray-500 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-400 rounded-lg shadow-none transition-colors ease-in-out">
            <i class="fas fa-radiation"></i>
            <span class="mx-2 text-sm">@lang('Standard Batch Subject')</span>
            </Link>
